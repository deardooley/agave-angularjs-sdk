        ...
        addMonitoringTasks : function(body){
            ...
            response.then(function(result){
                ...
                if (code == 400) {
                    ...
                    deffered.reject(APIHelper.appendContext({errorMessage: "The service was unable to save the monitor.", errorCode: 500, errorResponse: result.message},result.getContext()));
                    return;
                }
        ...
        getMonitoringTask : function(monitorId){
            ...
            response.then(function(result){
                ...
                if (code == 400) {
                    ...
                    deffered.reject(APIHelper.appendContext({errorMessage: "The specified Monitor cannot be found", errorCode: 404, errorResponse: result.message},result.getContext()));
                    return;
                } else if (code == 500) {
                    deffered.reject(APIHelper.appendContext({errorMessage: "The service was unable to process the request.", errorCode: 500, errorResponse: result.message},result.getContext()));
                    return;
                }
