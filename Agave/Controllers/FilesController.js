...
'use strict';
angular.module('agave.sdk').factory('FilesController', ['$q', '$localStorage', 'Configuration', 'HttpClient', 'APIHelper', function ($q, $localStorage, Configuration, HttpClient, APIHelper) {
    return {
